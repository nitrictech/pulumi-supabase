...
namespace Pulumi.Supabase.Storage
{
    [SupabaseResourceType("supabase:storage:Bucket")]
    public partial class Bucket : global::Pulumi.CustomResource
    {
        ...
        public Bucket(string name, BucketArgs args, CustomResourceOptions? options = null)
            : base("supabase:storage:Bucket", name, args ?? new BucketArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Bucket(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("supabase:storage:Bucket", name, null, MakeResourceOptions(options, id))
        {
        }

...
namespace Pulumi.Supabase.Secrets
{
    [SupabaseResourceType("supabase:secrets:Secret")]
    public partial class Secret : global::Pulumi.CustomResource
    {
        ...
        public Secret(string name, SecretArgs args, CustomResourceOptions? options = null)
            : base("supabase:secrets:Secret", name, args ?? new SecretArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Secret(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("supabase:secrets:Secret", name, null, MakeResourceOptions(options, id))
        {
        }

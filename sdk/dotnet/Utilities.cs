...
namespace Pulumi.Supabase
{
    static class Utilities
    {
        ...
        static Utilities()
        {
            ...
            using var stream = assembly.GetManifestResourceStream("Pulumi.Supabase.version.txt");
    ...
    internal sealed class SupabaseResourceTypeAttribute : global::Pulumi.ResourceTypeAttribute
    {
        public SupabaseResourceTypeAttribute(string type) : base(type, Utilities.Version)
        {
        }
    }
}

...
__all__ = ['PgFunctionArgs', 'PgFunction']

@pulumi.input_type
class PgFunctionArgs:
...
class PgFunction(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
                 ...
                 __props__=None):
        """
        Create a PgFunction resource with the given unique name, props, and options.
    ...
    def __init__(__self__,
        ...
        Create a PgFunction resource with the given unique name, props, and options.
        :param str resource_name: The name of the resource.
        :param PgFunctionArgs args: The arguments to use to populate this resource's properties.
        :param pulumi.ResourceOptions opts: Options for the resource.
        """
        ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(PgFunctionArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = PgFunctionArgs.__new__(PgFunctionArgs)
        ...
        super(PgFunction, __self__).__init__(
            'supabase:supabase:PgFunction',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name: str,
            id: pulumi.Input[str],
            opts: Optional[pulumi.ResourceOptions] = None) -> 'PgFunction':
        """
        ...
        return PgFunction(resource_name, opts=opts, __props__=__props__)

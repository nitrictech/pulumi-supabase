...
func NewOrganization(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("supabase:supabase:Organization", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetOrganization(ctx *pulumi.Context,
	...
	var resource Organization
	err := ctx.ReadResource("supabase:supabase:Organization", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil

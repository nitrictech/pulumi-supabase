...
func NewSecret(ctx *pulumi.Context,
	...
	var resource Secret
	err := ctx.RegisterResource("supabase:supabase:Secret", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetSecret(ctx *pulumi.Context,
	...
	var resource Secret
	err := ctx.ReadResource("supabase:supabase:Secret", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func (o SecretOutput) Project_id() pulumi.StringOutput {
	return o.ApplyT(func(v *Secret) pulumi.StringOutput { return v.Project_id }).(pulumi.StringOutput)
}

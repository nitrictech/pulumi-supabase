...
export class PgFunction extends pulumi.CustomResource {
    /**
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): PgFunction {
        return new PgFunction(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'supabase:supabase:PgFunction';

    /**
     * Returns true if the given object is an instance of PgFunction.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is PgFunction {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === PgFunction.__pulumiType;
    }
     ...
     */
    constructor(name: string, args: PgFunctionArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        super(PgFunction.__pulumiType, name, resourceInputs, opts);
    }
}
 ...
 */
export interface PgFunctionArgs {
